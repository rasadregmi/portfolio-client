      ...
      case 'help':
        output = (
          <div className="space-y-2 animate-fade-in">
            <p className="text-green-400 font-semibold mb-2 typing-effect">Available Commands:</p>
      ...
      >
        {showWelcome && (
          <div className="welcome-message mb-4 p-4 bg-gray-700/20 rounded-lg animate-fade-in">
            <h1 className="text-lg font-bold text-green-400 mb-2 typing-effect">Welcome to Terminal</h1>
            <p className="text-gray-400 mb-2">Type 'help' to see available commands</p>
        ...
        {commands.map((cmd, i) => (
          <div key={i} className="command-block mb-4 group animate-slide-up">
            <div className="flex items-center gap-2 text-sm command-prompt">
              ...
              <span className="text-white group-hover:text-green-300 transition-colors">{cmd.input}</span>
            </div>
